...
$(document).ready(function() {
    ...
    async function handleCheckHouseForm(event) {
        ...
        const housePassword = $('#housePassword').val(); // إضافة جلب الباسوورد
        ...
        // استدعاء checkHouse من check_house.js مع الباسوورد
        const response = await window.checkHouse(houseName, housePassword);
